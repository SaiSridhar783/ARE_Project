  ...
  <>
      ...
      <div className="wrapper">
        ...
        <div className="input-container">
          <h3 className="subheading" id="sub2">Result</h3>
	...
	<div className="table">
      ...
      <div className="table-row" id="even">
          ...
          <button className="next-button" onClick={data.data.clickHandler}>Change values</button>
          <button className="next-button" onClick={data.data.newvalues}>Enter new values</button>
           <ReactToPrint
     ...
     <Printpage data={data.data}  ref={data.data.componentRef}/>
  </div>
...
const Output = (props) => {
  ...
  let phim3 = 0,
    cm3 = 0
  if (props.σ3) {
    phim3 = utils.calculatePHIWithS3(a, mb, props.σ3, props.σci, s)
    cm3 = utils.calculateCohesionWithS3(props.σ3, props.σci, mb, a, s, phim3)
  }
  ...
  const erm3 = erm = utils.calculateErm(props.D, props.gsi, props.E_i).toFixed(4)
  const tens = utils.calculateTensileStress(props.σci, props.m_i).toFixed(4)
  const output_data = {crm:crm, frm:frm, ucs:ucs, erm:erm, tens:tens, phim3:phim3,cm3:cm3,componentRef:componentRef,clickHandler:clickHandler, newvalues:newvalues,...props}
  console.log(output_data)
  return (
    <Main data={output_data} />
  )
}
